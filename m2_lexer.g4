...
fragment ARROW_OPERATOR: 
    ANY_OP* (MINUS_OPERATOR | BITWISE_NOT_OPERATOR | EQUALS_OPERATOR) GREATER_THAN;
fragment ASSIGNMENT_OPERATOR: 
    (ASSIGNMENT_SPECIFIC_ANY_OP? EQUALS_OPERATOR)
    | (ASSIGNMENT_SPECIFIC_ANY_OP ANY_OP+ EQUALS_OPERATOR);
