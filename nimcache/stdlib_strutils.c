...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o '/home/carol/Desktop/Semester 10/Core/Compilers Lab/M2/NumberTwo/nimcache/stdlib_strutils.o' '/home/carol/Desktop/Semester 10/Core/Compilers Lab/M2/NumberTwo/nimcache/stdlib_strutils.c' */
...
N_NIMCALL(NIM_CHAR, nsuToUpperAsciiChar)(NIM_CHAR c) {
	...
	nimln_(232, "strutils.nim");
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_5 = subInt(((NI) (((NU8)(c)))), ((NI) 32));
...
N_NIMCALL(NimStringDesc*, nsuToUpperAsciiStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_4 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		colontmp_ = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_4);
		...
		res = ((NI) 0);
		{
			...
			while (1) {
				...
				TM_JGc9b9bh2D3nTdUR7TGyq8aA_6 = addInt(res, ((NI) 1));
				res = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_6);
			} LA3: ;
		}
	}
	popFrame();
...
N_NIMCALL(NimStringDesc*, nsuToUpperStr)(NimStringDesc* s) {
	NimStringDesc* result;
	nimfr_("toUpper", "strutils.nim");
	result = (NimStringDesc*)0;
	nimln_(368, "strutils.nim");
	nimln_(375, "strutils.nim");
	result = nsuToUpperAsciiStr(s);
	popFrame();
	return result;
}
