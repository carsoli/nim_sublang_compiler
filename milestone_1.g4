...
// fragment MULTILINE_COMMENT_BODY: (COMMENT_BODY+ | ( [\u0020-\u00FF] | TAB )*);
fragment MULTILINE_COMMENT_BODY: ( [\u0020-\u00FF] | TAB | NEWLINE)*;
MULTILINE_COMMENT: HASH OPEN_BRACK MULTILINE_COMMENT_BODY CLOSE_BRACK HASH;

DOCUMENTATION_COMMENT: HASH MULTILINE_COMMENT HASH;
// DOCUMENTATION_COMMENT: HASH (MULTILINE_COMMENT HASH | COMMENT_BODY);
...
// fragment PLATFORM_SPECIFIC_NEWLINE: (\u000A|\u000D \u000A);
